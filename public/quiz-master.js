...
/***/ function(module, exports, __webpack_require__) {
	...
	var redux_thunk_1 = __webpack_require__(68);
	var react_redux_1 = __webpack_require__(69);
	var Models_1 = __webpack_require__(82);
	var MasterControl_1 = __webpack_require__(85);
	var socket = null;
	function render(root, store) {
	    var App = react_redux_1.connect(function (state) { return { state: state }; })(MasterControl_1.MasterControl);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _storeShape = __webpack_require__(71);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MasterControl = (function (_super) {
	    __extends(MasterControl, _super);
	    function MasterControl() {
	        _super.apply(this, arguments);
	    }
	    MasterControl.prototype.handleMasterReset = function (e) {
	        e.preventDefault();
	        this.props.dispatch({
	    ...
	    MasterControl.prototype.handleMasterEnd = function (e) {
	        e.preventDefault();
	        this.props.dispatch({
	            type: Models_1.ActionType.MasterOperation,
	            payload: {
	    ...
	    MasterControl.prototype.handleMasterChoice = function (rightChoice, e) {
	        e.preventDefault();
	        this.props.dispatch({
	            type: Models_1.ActionType.MasterOperation,
	            payload: {
	    ...
	    MasterControl.prototype.handleMasterHint = function (hint, score, e) {
	        e.preventDefault();
	        this.props.dispatch({
	            type: Models_1.ActionType.MasterOperation,
	            payload: {
	    ...
	    MasterControl.prototype.handleMasterTimeout = function (e) {
	        e.preventDefault();
	        this.props.dispatch({
	            type: Models_1.ActionType.MasterOperation,
	            payload: {
	    ...
	    MasterControl.prototype.render = function () {
	        var state = this.props.state;
	        var mainView = this.makeMasterView();
...
/***/ }
/******/ ]);
//# sourceMappingURL=quiz-master.js.map